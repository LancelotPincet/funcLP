...
from ._Gaussian2D_gpukernel_d_pixx import _Gaussian2D_gpukernel_d_pixx as kernel
import numba as nb
from numba import cuda
@nb.cuda.jit(cache=True, fastmath=False)
def _Gaussian2D_gpu_d_pixx(x, y, mux, muy, sigx, sigy, amp, offset, pixx, pixy, nsig, theta, out, ignore) :
