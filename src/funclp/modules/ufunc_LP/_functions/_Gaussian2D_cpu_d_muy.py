...
from ._Gaussian2D_cpukernel_d_muy import _Gaussian2D_cpukernel_d_muy as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=True, parallel=True)
def _Gaussian2D_cpu_d_muy(x, y, mux, muy, sigx, sigy, amp, offset, pixx, pixy, nsig, theta, out, ignore) :
