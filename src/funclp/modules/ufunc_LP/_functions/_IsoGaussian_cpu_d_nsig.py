...
from ._IsoGaussian_cpukernel_d_nsig import _IsoGaussian_cpukernel_d_nsig as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=False, parallel=True)
def _IsoGaussian_cpu_d_nsig(x, y, mux, muy, sig, amp, offset, pixx, pixy, nsig, eps, out, ignore) :
