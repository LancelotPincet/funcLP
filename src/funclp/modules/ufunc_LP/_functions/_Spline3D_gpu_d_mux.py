...
from ._Spline3D_gpukernel_d_mux import _Spline3D_gpukernel_d_mux as kernel
import numba as nb
from numba import cuda
@nb.cuda.jit(cache=True, fastmath=True)
def _Spline3D_gpu_d_mux(x, y, z, mux, muy, muz, amp, offset, kx, ky, kz, tx, ty, tz, coeffs, out, ignore) :
