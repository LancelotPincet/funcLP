...
from ._Gaussian2D_gpukernel_d_offset import _Gaussian2D_gpukernel_d_offset as kernel
import numba as nb
from numba import cuda
@nb.cuda.jit(cache=True, fastmath=True)
def _Gaussian2D_gpu_d_offset(x, y, mux, muy, sigx, sigy, amp, offset, pixx, pixy, nsig, theta, out, ignore) :
