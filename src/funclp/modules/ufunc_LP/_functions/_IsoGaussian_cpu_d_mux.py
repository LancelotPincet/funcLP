...
from ._IsoGaussian_cpukernel_d_mux import _IsoGaussian_cpukernel_d_mux as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=True, parallel=True)
def _IsoGaussian_cpu_d_mux(x, y, mux, muy, sig, amp, offset, pixx, pixy, nsig, out, ignore) :
