...
from ._IsoGaussian_gpukernel_d_mux import _IsoGaussian_gpukernel_d_mux as kernel
import numba as nb
from numba import cuda
@nb.cuda.jit(cache=True, fastmath=True)
def _IsoGaussian_gpu_d_mux(x, y, mux, muy, sig, amp, offset, pixx, pixy, nsig, out, ignore) :
