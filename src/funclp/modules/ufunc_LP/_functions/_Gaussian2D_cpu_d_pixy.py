...
from ._Gaussian2D_cpukernel_d_pixy import _Gaussian2D_cpukernel_d_pixy as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=False, parallel=True)
def _Gaussian2D_cpu_d_pixy(x, y, mux, muy, sigx, sigy, amp, offset, pixx, pixy, nsig, theta, out, ignore) :
