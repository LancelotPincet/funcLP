...
from ._IsoGaussian_cpukernel_d_pixy import _IsoGaussian_cpukernel_d_pixy as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=False, parallel=True)
def _IsoGaussian_cpu_d_pixy(x, y, mux, muy, sig, amp, offset, pixx, pixy, nsig, eps, out, ignore) :
