...
from ._IsoGaussian_gpukernel_d_nsig import _IsoGaussian_gpukernel_d_nsig as kernel
import numba as nb
from numba import cuda
@nb.cuda.jit(cache=True, fastmath=False)
def _IsoGaussian_gpu_d_nsig(x, y, mux, muy, sig, amp, offset, pixx, pixy, nsig, eps, out, ignore) :
