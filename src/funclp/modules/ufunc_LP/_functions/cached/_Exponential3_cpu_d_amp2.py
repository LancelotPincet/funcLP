...
from ._Exponential3_cpukernel_d_amp2 import _Exponential3_cpukernel_d_amp2 as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=True, parallel=True)
def _Exponential3_cpu_d_amp2(t, tau1, tau2, tau3, amp1, amp2, amp3, offset, out, ignore) :
