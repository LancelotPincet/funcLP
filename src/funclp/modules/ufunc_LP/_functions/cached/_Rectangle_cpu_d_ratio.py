...
from ._Rectangle_cpukernel_d_ratio import _Rectangle_cpukernel_d_ratio as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=False, parallel=True)
def _Rectangle_cpu_d_ratio(x, y, l, ratio, mux, muy, amp, offset, theta, out, ignore) :
