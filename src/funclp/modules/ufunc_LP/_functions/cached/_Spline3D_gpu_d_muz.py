...
from ._Spline3D_gpukernel_d_muz import _Spline3D_gpukernel_d_muz as kernel
import numba as nb
from numba import cuda
@nb.cuda.jit(cache=True, fastmath=True)
def _Spline3D_gpu_d_muz(x, y, z, mux, muy, muz, amp, offset, kx, ky, kz, tx, ty, tz, coeffs, out, ignore) :
