...
from ._Spline3D_gpukernel_d_kz import _Spline3D_gpukernel_d_kz as kernel
import numba as nb
from numba import cuda
@nb.cuda.jit(cache=True, fastmath=False)
def _Spline3D_gpu_d_kz(x, y, z, mux, muy, muz, amp, offset, kx, ky, kz, tx, ty, tz, coeffs, out, ignore) :
