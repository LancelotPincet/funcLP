...
def d_muy(x, y, /, l, ratio, mux, muy, amp, offset, theta):
    eps = 1e-3 * max(1.0, abs(muy))
    f_plus = kernel(x, y, l, ratio, mux, muy + eps, amp, offset, theta)
    f_minus = kernel(x, y, l, ratio, mux, muy - eps, amp, offset, theta)
