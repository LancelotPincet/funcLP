...
def d_mux(x, y, /, l, ratio, mux, muy, amp, offset, theta):
    eps = 1e-3 * max(1.0, abs(mux))
    f_plus = kernel(x, y, l, ratio, mux + eps, muy, amp, offset, theta)
    f_minus = kernel(x, y, l, ratio, mux - eps, muy, amp, offset, theta)
