...
from ._Spline3D_cpukernel_d_mux import _Spline3D_cpukernel_d_mux as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=True, parallel=True)
def _Spline3D_cpu_d_mux(x, y, z, mux, muy, muz, amp, offset, kx, ky, kz, tx, ty, tz, coeffs, out, ignore) :
