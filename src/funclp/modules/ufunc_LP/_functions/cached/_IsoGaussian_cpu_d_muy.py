...
from ._IsoGaussian_cpukernel_d_muy import _IsoGaussian_cpukernel_d_muy as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=True, parallel=True)
def _IsoGaussian_cpu_d_muy(x, y, mux, muy, sig, amp, offset, pixx, pixy, nsig, out, ignore) :
