...
from ._Rectangle_cpukernel_d_offset import _Rectangle_cpukernel_d_offset as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=False, parallel=True)
def _Rectangle_cpu_d_offset(x, y, l, ratio, mux, muy, amp, offset, theta, out, ignore) :
