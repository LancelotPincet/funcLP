...
def d_ratio(x, y, /, l, ratio, mux, muy, amp, offset, theta):
    eps = 1e-3 * max(1.0, abs(ratio))
    f_plus = kernel(x, y, l, ratio + eps, mux, muy, amp, offset, theta)
    f_minus = kernel(x, y, l, ratio - eps, mux, muy, amp, offset, theta)
