...
def d_pixy(x, y, z, /, mux, muy, muz, sigx, sigy, sigz, amp, offset, pixx, pixy, pixz, nsig, theta, phi, eps=1e-4):
    f_plus = kernel(x, y, z, mux, muy, muz, sigx, sigy, sigz, amp, offset, pixx, pixy + eps, pixz, nsig, theta, phi)
    f_minus = kernel(x, y, z, mux, muy, muz, sigx, sigy, sigz, amp, offset, pixx, pixy - eps, pixz, nsig, theta, phi)
