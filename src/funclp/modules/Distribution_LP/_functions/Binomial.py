...
class Binomial(Distribution) :
    ...
    def loglikelihood_reduced(raw_data, model_data, /, n=np.int32(1), eps=np.float32(1e-6), weights=np.float32(1.)):
    ...
    @ufunc(data=['raw_data', 'model_data'])
    def loglikelihood(raw_data, model_data, /, n=np.int32(1), eps=np.float32(1e-6), weights=np.float32(1.)):
    ...
    @ufunc(data=['raw_data', 'model_data'])
    def dloglikelihood(raw_data, model_data, /, n=np.int32(1), eps=np.float32(1e-6), weights=np.float32(1.)):
    ...
    @ufunc(data=['raw_data', 'model_data'])
    def d2loglikelihood(raw_data, model_data, /, n=np.int32(1), eps=np.float32(1e-6), weights=np.float32(1.)):
    ...
    @ufunc(data=['raw_data', 'model_data'])
    def fisher(raw_data, model_data, /, n=np.int32(1), eps=np.float32(1e-6), weights=np.float32(1.)):
