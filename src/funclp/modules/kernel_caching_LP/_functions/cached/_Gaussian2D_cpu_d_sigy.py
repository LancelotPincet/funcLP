...
from ._Gaussian2D_cpukernel_d_sigy import _Gaussian2D_cpukernel_d_sigy as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=True, parallel=True)
def _Gaussian2D_cpu_d_sigy(x, y, mux, muy, sigx, sigy, amp, offset, pixx, pixy, nsig, theta, out, ignore) :
