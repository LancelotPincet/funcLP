import numpy as np
import numba as nb
from ._Polynomial4_cpukernel_function import _Polynomial4_cpukernel_function as model_scalar
...
def _Polynomial4_MLE_Binomial_cpu_assembly(
    ...
    for model in nb.prange(nmodels):
        ...
        for point in range(npoints):
            ...
            mod = model_scalar(point_x, model_a, model_b, model_c, model_d, model_e)
            ...
            count = 0
            if bool2fit[0]:
                jacob_local[count] = d_a(point_x, model_a, model_b, model_c, model_d, model_e)
                count += 1
            if bool2fit[1]:
                jacob_local[count] = d_b(point_x, model_a, model_b, model_c, model_d, model_e)
                count += 1
            if bool2fit[2]:
                jacob_local[count] = d_c(point_x, model_a, model_b, model_c, model_d, model_e)
                count += 1
            if bool2fit[3]:
                jacob_local[count] = d_d(point_x, model_a, model_b, model_c, model_d, model_e)
                count += 1
            if bool2fit[4]:
                jacob_local[count] = d_e(point_x, model_a, model_b, model_c, model_d, model_e)
                count += 1
