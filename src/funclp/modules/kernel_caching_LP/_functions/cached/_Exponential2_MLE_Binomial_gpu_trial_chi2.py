...
def _Exponential2_MLE_Binomial_gpu_trial_chi2(
    raw_data, t, tau1, tau2, amp1, amp2, offset, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_t, block_tau1, block_tau2, block_amp1, block_amp2, block_offset)
