...
def _Spline2D_MLE_Binomial_gpu_trial_chi2(
    raw_data, x, y, mux, muy, amp, offset, kx, ky, tx, ty, coeffs, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, thread_y, block_mux, block_muy, block_amp, block_offset, block_kx, block_ky, tx, ty, coeffs)
