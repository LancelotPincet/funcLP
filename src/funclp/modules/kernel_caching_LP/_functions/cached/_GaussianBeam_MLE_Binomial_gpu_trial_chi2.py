...
def _GaussianBeam_MLE_Binomial_gpu_trial_chi2(
    raw_data, z, w0, z0, m2, wl, n, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_z, block_w0, block_z0, block_m2, block_wl, block_n)
