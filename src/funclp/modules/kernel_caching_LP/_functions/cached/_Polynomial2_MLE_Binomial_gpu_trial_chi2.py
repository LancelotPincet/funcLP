...
def _Polynomial2_MLE_Binomial_gpu_trial_chi2(
    raw_data, x, a, b, c, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, block_a, block_b, block_c)
