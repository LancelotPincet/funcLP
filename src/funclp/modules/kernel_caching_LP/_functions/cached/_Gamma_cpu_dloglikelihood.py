...
from ._Gamma_cpukernel_dloglikelihood import _Gamma_cpukernel_dloglikelihood as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=True, parallel=True)
def _Gamma_cpu_dloglikelihood(raw_data, model_data, weights, k, eps, out, ignore) :
