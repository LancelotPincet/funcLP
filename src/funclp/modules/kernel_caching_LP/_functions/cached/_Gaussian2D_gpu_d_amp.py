...
from ._Gaussian2D_gpukernel_d_amp import _Gaussian2D_gpukernel_d_amp as kernel
import numba as nb
from numba import cuda
@nb.cuda.jit(cache=True, fastmath=True)
def _Gaussian2D_gpu_d_amp(x, y, mux, muy, sigx, sigy, amp, offset, pixx, pixy, nsig, theta, out, ignore) :
