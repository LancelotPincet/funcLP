...
def _IsoGaussian_MLE_Binomial_gpu_trial_chi2(
    raw_data, x, y, mux, muy, sig, amp, offset, pixx, pixy, nsig, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, thread_y, block_mux, block_muy, block_sig, block_amp, block_offset, block_pixx, block_pixy, block_nsig)
