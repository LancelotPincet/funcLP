...
def _Gaussian2D_MLE_Binomial_gpu_trial_chi2(
    raw_data, x, y, mux, muy, sigx, sigy, amp, offset, pixx, pixy, nsig, theta, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, thread_y, block_mux, block_muy, block_sigx, block_sigy, block_amp, block_offset, block_pixx, block_pixy, block_nsig, block_theta)
