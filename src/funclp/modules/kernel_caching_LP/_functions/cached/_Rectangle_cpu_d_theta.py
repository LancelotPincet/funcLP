...
from ._Rectangle_cpukernel_d_theta import _Rectangle_cpukernel_d_theta as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=False, parallel=True)
def _Rectangle_cpu_d_theta(x, y, l, ratio, mux, muy, amp, offset, theta, out, ignore) :
