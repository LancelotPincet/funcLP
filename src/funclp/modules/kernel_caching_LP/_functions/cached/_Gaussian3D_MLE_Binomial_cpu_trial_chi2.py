...
def _Gaussian3D_MLE_Binomial_cpu_trial_chi2(
    raw_data, x, y, z, mux, muy, muz, sigx, sigy, sigz, amp, offset, pixx, pixy, pixz, nsig, theta, phi, weights, chi2, parameters, indices, steps, gradient,
