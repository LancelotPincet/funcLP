...
def _Exponential1_MLE_Binomial_gpu_trial_chi2(
    raw_data, t, tau, amp, offset, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_t, block_tau, block_amp, block_offset)
