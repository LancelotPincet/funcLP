...
from ._Spline2D_gpukernel_function import _Spline2D_gpukernel_function as model_scalar
...
from ._Spline2D_gpukernel_d_mux import _Spline2D_gpukernel_d_mux as d_mux
from ._Spline2D_gpukernel_d_muy import _Spline2D_gpukernel_d_muy as d_muy
from ._Spline2D_gpukernel_d_amp import _Spline2D_gpukernel_d_amp as d_amp
from ._Spline2D_gpukernel_d_offset import _Spline2D_gpukernel_d_offset as d_offset
from ._Spline2D_gpukernel_d_kx import _Spline2D_gpukernel_d_kx as d_kx
from ._Spline2D_gpukernel_d_ky import _Spline2D_gpukernel_d_ky as d_ky
...
def _Spline2D_MLE_Binomial_gpu_assembly(
    raw_data, x, y, mux, muy, amp, offset, kx, ky, tx, ty, coeffs, weights, chi2, gradient, hessian, bool2fit, ignore
):
    ...
    for point in range(tid, npoints, bdim):
        ...
        mod = model_scalar(thread_x, thread_y, block_mux, block_muy, block_amp, block_offset, block_kx, block_ky, tx, ty, coeffs)
