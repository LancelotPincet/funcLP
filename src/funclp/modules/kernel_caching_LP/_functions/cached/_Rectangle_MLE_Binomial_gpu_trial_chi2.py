...
def _Rectangle_MLE_Binomial_gpu_trial_chi2(
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, thread_y, block_l, block_ratio, block_mux, block_muy, block_amp, block_offset, block_theta)
