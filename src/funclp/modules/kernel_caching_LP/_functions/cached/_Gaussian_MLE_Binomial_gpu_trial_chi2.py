...
def _Gaussian_MLE_Binomial_gpu_trial_chi2(
    raw_data, x, mu, sig, amp, offset, pix, nsig, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, block_mu, block_sig, block_amp, block_offset, block_pix, block_nsig)
