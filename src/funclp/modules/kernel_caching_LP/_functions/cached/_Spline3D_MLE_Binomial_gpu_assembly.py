...
from ._Spline3D_gpukernel_d_mux import _Spline3D_gpukernel_d_mux as d_mux
from ._Spline3D_gpukernel_d_muy import _Spline3D_gpukernel_d_muy as d_muy
from ._Spline3D_gpukernel_d_muz import _Spline3D_gpukernel_d_muz as d_muz
from ._Spline3D_gpukernel_d_amp import _Spline3D_gpukernel_d_amp as d_amp
from ._Spline3D_gpukernel_d_offset import _Spline3D_gpukernel_d_offset as d_offset
from ._Spline3D_gpukernel_d_kx import _Spline3D_gpukernel_d_kx as d_kx
from ._Spline3D_gpukernel_d_ky import _Spline3D_gpukernel_d_ky as d_ky
from ._Spline3D_gpukernel_d_kz import _Spline3D_gpukernel_d_kz as d_kz
...
def _Spline3D_MLE_Binomial_gpu_assembly(
    ...
    for point in range(tid, npoints, bdim):
        ...
        mod = model_scalar(thread_x, thread_y, thread_z, block_mux, block_muy, block_muz, block_amp, block_offset, block_kx, block_ky, block_kz, tx, ty, tz, coeffs)
