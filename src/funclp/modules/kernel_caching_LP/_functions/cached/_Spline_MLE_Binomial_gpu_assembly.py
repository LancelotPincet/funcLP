...
from ._Spline_gpukernel_function import _Spline_gpukernel_function as model_scalar
...
def _Spline_MLE_Binomial_gpu_assembly(
    ...
    for point in range(tid, npoints, bdim):
        ...
        mod = model_scalar(thread_x, block_mu, block_amp, block_offset, block_k, t, coeffs)
