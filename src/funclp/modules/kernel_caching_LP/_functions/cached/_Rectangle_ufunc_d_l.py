...
def d_l(x, y, /, l, ratio, mux, muy, amp, offset, theta):
    eps = 1e-3 * max(1.0, abs(l))
    f_plus = kernel(x, y, l + eps, ratio, mux, muy, amp, offset, theta)
    f_minus = kernel(x, y, l - eps, ratio, mux, muy, amp, offset, theta)
