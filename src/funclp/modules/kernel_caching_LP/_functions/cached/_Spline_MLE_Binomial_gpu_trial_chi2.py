...
def _Spline_MLE_Binomial_gpu_trial_chi2(
    raw_data, x, mu, amp, offset, k, t, coeffs, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, block_mu, block_amp, block_offset, block_k, t, coeffs)
