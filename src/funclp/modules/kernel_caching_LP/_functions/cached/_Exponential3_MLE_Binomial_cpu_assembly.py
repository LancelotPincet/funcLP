import numpy as np
import numba as nb
from ._Exponential3_cpukernel_function import _Exponential3_cpukernel_function as model_scalar
...
def _Exponential3_MLE_Binomial_cpu_assembly(
    ...
    for model in nb.prange(nmodels):
        ...
        model_tau3 = tau3[model]
        model_amp1 = amp1[model]
        model_amp2 = amp2[model]
        model_amp3 = amp3[model]
        ...
        for point in range(npoints):
            ...
            mod = model_scalar(point_t, model_tau1, model_tau2, model_tau3, model_amp1, model_amp2, model_amp3, model_offset)
            ...
            count = 0
            if bool2fit[0]:
                jacob_local[count] = d_tau1(point_t, model_tau1, model_tau2, model_tau3, model_amp1, model_amp2, model_amp3, model_offset)
                count += 1
            if bool2fit[1]:
                jacob_local[count] = d_tau2(point_t, model_tau1, model_tau2, model_tau3, model_amp1, model_amp2, model_amp3, model_offset)
                count += 1
            if bool2fit[2]:
                jacob_local[count] = d_tau3(point_t, model_tau1, model_tau2, model_tau3, model_amp1, model_amp2, model_amp3, model_offset)
                count += 1
            if bool2fit[3]:
                jacob_local[count] = d_amp1(point_t, model_tau1, model_tau2, model_tau3, model_amp1, model_amp2, model_amp3, model_offset)
                count += 1
            if bool2fit[4]:
                jacob_local[count] = d_amp2(point_t, model_tau1, model_tau2, model_tau3, model_amp1, model_amp2, model_amp3, model_offset)
                count += 1
            if bool2fit[5]:
                jacob_local[count] = d_amp3(point_t, model_tau1, model_tau2, model_tau3, model_amp1, model_amp2, model_amp3, model_offset)
                count += 1
            if bool2fit[6]:
                jacob_local[count] = d_offset(point_t, model_tau1, model_tau2, model_tau3, model_amp1, model_amp2, model_amp3, model_offset)
                count += 1
