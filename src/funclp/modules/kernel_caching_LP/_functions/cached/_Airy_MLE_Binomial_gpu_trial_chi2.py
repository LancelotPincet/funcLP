...
def _Airy_MLE_Binomial_gpu_trial_chi2(
    raw_data, x, mu, amp, offset, wl, NA, tol, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, block_mu, block_amp, block_offset, block_wl, block_NA, block_tol)
