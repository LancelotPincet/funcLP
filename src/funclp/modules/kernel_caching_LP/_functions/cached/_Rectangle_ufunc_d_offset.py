...
def d_offset(x, y, /, l, ratio, mux, muy, amp, offset, theta):
    eps = 1e-3 * max(1.0, abs(offset))
    f_plus = kernel(x, y, l, ratio, mux, muy, amp, offset + eps, theta)
    f_minus = kernel(x, y, l, ratio, mux, muy, amp, offset - eps, theta)
