...
def _Disc_MLE_Binomial_gpu_trial_chi2(
    raw_data, x, y, r, mux, muy, amp, offset, weights, chi2, parameters, indices, steps, gradient,
    ...
    for point in range(tid, npoints, bdim):
        ...
        pred = model_scalar(thread_x, thread_y, block_r, block_mux, block_muy, block_amp, block_offset)
