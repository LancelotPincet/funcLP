...
from ._Spline3D_cpukernel_d_kz import _Spline3D_cpukernel_d_kz as kernel
import numba as nb
@nb.njit(nogil=True, cache=True, fastmath=False, parallel=True)
def _Spline3D_cpu_d_kz(x, y, z, mux, muy, muz, amp, offset, kx, ky, kz, tx, ty, tz, coeffs, out, ignore) :
