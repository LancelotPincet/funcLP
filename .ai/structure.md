...
- The library is organized under `src/funclp` into two main parts:
...
- The main object is defined in:
  - `myname.py`
  - and imported as: `from funclp import myname`
...
- All such objects become importable from the package root directly with ```from funclp import myname```.
